...
the same as before) until you accumulate several more values of each.\sidenote{These procedures are a restatement of the instructions given in steps 5-8 in the manual at the top of page 9).}
